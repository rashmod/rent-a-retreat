...
import ListingImageRoutes from './routes/ListingImageRoutes';
import ProfileImageRoutes from './routes/ProfileImageRoutes';
...
app.use('/api/listing', ListingImageRoutes);
app.use('/api/user', ProfileImageRoutes);
